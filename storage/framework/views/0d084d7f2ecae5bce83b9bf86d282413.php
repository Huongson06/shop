                                                ...
                                                <div class="row margin-default ratio_square">
                                                    <?php $__currentLoopData = $subcats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-xl-2 col-sm-3 col-4">
                                                            <a href="<?php echo e(route('front.product.cat',$subcat->slug)); ?>">
                                                                <div class="img-category">
                                                                    <div style="max-height:120px" class="img-sec">
                                                                        <img   src="<?php echo e($subcat->photo?$subcat->photo:asset('frontend/assets/images/fashion/category/1.jpg')); ?>" class="img-fluid bg-img" alt="<?php echo e($subcat->title); ?>">
                                                                    </div>
                                                                    <h5><?php echo e($subcat->title); ?></h5>
                                                                </div>
                                                            </a>
                                                        </div>
                                                        ...
                                                        <div class="img-wrapper">
                                                            <div class="front">
                                                                <a href="<?php echo e(route('front.product.view',$product->slug)); ?>">
                                                                    <img src="<?php echo e(count($photos)>0?$photos[0]:asset('frontend/assets/images/pro3/35.jpg')); ?>"
                                ...
                                <?php
                                    ...
                                    for($i = 0;  $i < 3 && $i < count($poppros);$i ++)
                                    {
                                        ...
                                        ?>
                                            <div class="media">
                                                <a href=""><img style="max-width:160px; max-height:160px" class="img-fluid blur-up lazyload"
                                                        src="<?php echo e(count($nphotos)>0?$nphotos[0]:asset('frontend/assets/images/fashion/pro/1.jpg')); ?>" alt=""></a>
                                                <div class="media-body align-self-center">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\shop\resources\views/frontend/product/category.blade.php ENDPATH**/ ?>