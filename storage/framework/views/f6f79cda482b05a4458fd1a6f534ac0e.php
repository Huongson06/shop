            ...
            success: function(response) {
                ...
                innerhtml  +=' <li>  <div class="total">  <h5>Tổng : <span>'
                  + Intl.NumberFormat().format(total)+'</span></h5>'
                    ...
                    +'xem giỏ hàng</a> <a href="'+'<?php echo e(route("front.shopingcart.checkout")); ?>'+'" class="checkout">Mua hàng</a></div>  </li>';
...
<?php /**PATH C:\laragon\www\shop\resources\views/frontend/layouts/foot.blade.php ENDPATH**/ ?>